...
namespace Infrangible\CatalogProductOptionDefault\Plugin\Catalog\Ui\DataProvider\Product\Form\Modifier;
...
class CustomOptions
{
    public const FIELD_DEFAULT_NAME = 'default';
    ...
    protected function getDefaultFieldConfig(int $sortOrder): array
    {
        return [
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'dataScope'     => static::FIELD_DEFAULT_NAME,
                        'dataType'      => Text::NAME,
                        'sortOrder'     => $sortOrder,
                        'value'         => '0',
                        'valueMap'      => [
